defmodule ReloadBugWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReloadBugWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReloadBugWeb.Gettext, "errors", msg, opts)
    end
  end
